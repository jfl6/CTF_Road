...
![](https://cdn.nlark.com/yuque/0/2025/png/52728443/1743735236633-06cc84a5-6dd7-4c61-b85c-40964a9c299f.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/52728443/1743735255751-5ca2433a-e84d-4180-8c85-246abd4428ea.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/52728443/1743827914587-f53c2b38-9b22-49bd-8530-5c00d7c2ef1b.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/52728443/1743853928936-2afd1d93-62cc-46ff-be83-b699618e645b.png)再foremost，得到zip和png，压缩包密码XYCTF2025也可根据提示掩码爆破XYCTF????

，解压得到另看起来一张一样的png，一眼双图盲水印

![](https://cdn.nlark.com/yuque/0/2025/png/52728443/1743853949929-fdceccc8-0677-4d30-ae7d-30c7557f25a0.png)
...
### Division
 利用成熟的 mt19937predictor 库（[https://github.com/kmyk/mersenne-twister-predictor](https://github.com/kmyk/mersenne-twister-predictor)）实现对random.getrandbits漏洞攻击
...
## Reverse
### WARWUP
下载附件发现是vbs逆向，之前没做过，上网查阅了一下，发现<font style="color:rgb(77, 77, 77);">将前面的Execute改成 wscript.echo之后就可以直接阅读源代码了</font>

![](https://cdn.nlark.com/yuque/0/2025/png/54704512/1743902016863-9d25b445-de42-4892-897b-173459fcd078.png)

源代码如图：

![](https://cdn.nlark.com/yuque/0/2025/png/54704512/1743902042219-9b41e5b6-63e7-4b5e-9c2c-15f0ac4f132d.png)

分析一下是rc4加密，将wefbuwiue的密文和qwfe的密钥复制下来，塞进解密工具中

![](https://cdn.nlark.com/yuque/0/2025/png/54704512/1743902248292-da11b2f3-e939-40ee-9a3b-41fb41ff4c72.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/54704512/1743902942486-0e1ae63d-efc5-4b84-b094-ba35f121b498.png)

![](https://cdn.nlark.com/yuque/0/2025/png/54704512/1743903354521-8e040106-7e04-4b61-b50e-886f598b3218.png)
...
![](https://cdn.nlark.com/yuque/0/2025/png/54704512/1743903421599-e36cd1d4-f22e-4b0a-92ae-c0745cc32cd9.png)

进入unk_370提取<font style="color:rgb(64, 64, 64);">每个QWORD的字节，</font>![](https://cdn.nlark.com/yuque/0/2025/png/54704512/1743903917017-913495e8-3362-40dd-b5fb-5d84a6e563a4.png)

<font style="color:rgb(64, 64, 64);">并按小端序转换为整数用python写脚本实现calculate_crc64_direct函数，针对每个目标CRC64值，枚举所有可能的双字符组合，找到匹配的组合。</font>

<font style="color:rgb(64, 64, 64);">脚本如下</font>
...
**<font style="color:rgb(34, 34, 34);">flag{LLVM_1s_Fun_Ri9h7?}</font>**

## <font style="color:rgb(34, 34, 34);">Web</font>
### ez_puzzle
...
![](https://cdn.nlark.com/yuque/0/2025/png/52728443/1743910967055-4428c768-42e5-4d0d-a8a2-695e0bf602f8.png)
